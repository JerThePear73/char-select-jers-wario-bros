...
local HANDS_J_WARIO = {
    [CHAR_ANIM_WALK_WITH_LIGHT_OBJ] = MARIO_HAND_RIGHT_OPEN,
    [CHAR_ANIM_RUN_WITH_LIGHT_OBJ] = MARIO_HAND_RIGHT_OPEN,
    [CHAR_ANIM_SLOW_WALK_WITH_LIGHT_OBJ] = MARIO_HAND_RIGHT_OPEN,
    [CHAR_ANIM_JUMP_WITH_LIGHT_OBJ] = MARIO_HAND_RIGHT_OPEN,
    [CHAR_ANIM_FALL_WITH_LIGHT_OBJ] = MARIO_HAND_RIGHT_OPEN,
    [CHAR_ANIM_FALL_FROM_SLIDING_WITH_LIGHT_OBJ] = MARIO_HAND_RIGHT_OPEN,
    [CHAR_ANIM_IDLE_WITH_LIGHT_OBJ] = MARIO_HAND_RIGHT_OPEN,
    [CHAR_ANIM_JUMP_LAND_WITH_LIGHT_OBJ] = MARIO_HAND_RIGHT_OPEN,
    [CHAR_ANIM_FALL_LAND_WITH_LIGHT_OBJ] = MARIO_HAND_RIGHT_OPEN,
    [CHAR_ANIM_STAND_UP_FROM_SLIDING_WITH_LIGHT_OBJ] = MARIO_HAND_RIGHT_OPEN,
    [CHAR_ANIM_PICK_UP_LIGHT_OBJ] = MARIO_HAND_RIGHT_OPEN,
    [CHAR_ANIM_PLACE_LIGHT_OBJ] = MARIO_HAND_RIGHT_OPEN,
    [CHAR_ANIM_STOP_SLIDE_LIGHT_OBJ] = MARIO_HAND_RIGHT_OPEN,
    [CHAR_ANIM_THROW_LIGHT_OBJECT] = MARIO_HAND_RIGHT_OPEN,
    [CHAR_ANIM_GROUND_THROW] = MARIO_HAND_RIGHT_OPEN,
...
if _G.charSelectExists then
    ...
    _G.CT_J_SYRUP = _G.charSelect.character_add("Captain Syrup", { "A cunning treasure hunter in search of goodies. What is her reason for helping the Wario Bros.?",
