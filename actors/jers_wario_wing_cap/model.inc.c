Lights1 jers_wario_wing_cap_Cap_Dark__CAP__lights = gdSPDefLights1(
	0x7F, 0x5F, 0x0,
	0xFF, 0xC1, 0x0, 0x28, 0x28, 0x28);

Lights1 jers_wario_wing_cap_Cap__CAP__lights = gdSPDefLights1(
	0x7F, 0x5F, 0x0,
	0xFF, 0xC1, 0x0, 0x28, 0x28, 0x28);

Lights1 jers_wario_wing_cap_Emblem__EMBLEM__layer2_lights = gdSPDefLights1(
	0x0, 0x0, 0xFF,
	0x0, 0x0, 0x0, 0x28, 0x28, 0x28);

Gfx jers_wario_wing_cap_wing_ia8_aligner[] = {gsSPEndDisplayList()};
u8 jers_wario_wing_cap_wing_ia8[] = {
	#include "actors/jers_wario_wing_cap/wing.ia8.inc.c"
};

Gfx jers_wario_wing_cap_wario_cutout_i8_aligner[] = {gsSPEndDisplayList()};
u8 jers_wario_wing_cap_wario_cutout_i8[] = {
	#include "actors/jers_wario_wing_cap/wario_cutout.i8.inc.c"
};

Gfx jers_wario_wing_cap_logo_W_i8_aligner[] = {gsSPEndDisplayList()};
u8 jers_wario_wing_cap_logo_W_i8[] = {
	#include "actors/jers_wario_wing_cap/logo_W.i8.inc.c"
};

Vtx jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_4_vtx_0[8] = {
...
Gfx jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_4_tri_0[] = {
	gsSPVertex(jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_4_vtx_0 + 0, 8, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
	gsSP2Triangles(4, 5, 6, 0, 4, 7, 5, 0),
	gsSPEndDisplayList(),
};

Vtx jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_1_vtx_0[13] = {
...
Gfx jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_1_tri_0[] = {
	gsSPVertex(jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_1_vtx_0 + 0, 13, 0),
...
Vtx jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_1_vtx_1[56] = {
...
Gfx jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_1_tri_1[] = {
	gsSPVertex(jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_1_vtx_1 + 0, 32, 0),
	...
	gsSPVertex(jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_1_vtx_1 + 32, 24, 0),
...
Vtx jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_2_vtx_0[6] = {
...
Gfx jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_2_tri_0[] = {
	gsSPVertex(jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_2_vtx_0 + 0, 6, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
Gfx mat_jers_wario_wing_cap_Wing_New[] = {
	gsSPGeometryMode(G_CULL_BACK, 0),
	gsDPPipeSync(),
	gsDPSetCombineLERP(0, 0, 0, TEXEL0, TEXEL0, 0, ENVIRONMENT, 0, 0, 0, 0, TEXEL0, TEXEL0, 0, ENVIRONMENT, 0),
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_IA, G_IM_SIZ_8b_LOAD_BLOCK, 1, jers_wario_wing_cap_wing_ia8),
...
Gfx mat_revert_jers_wario_wing_cap_Wing_New[] = {
	gsSPGeometryMode(0, G_CULL_BACK),
	gsDPPipeSync(),
	gsSPEndDisplayList(),
};

Gfx mat_jers_wario_wing_cap_Cap_Dark__CAP_[] = {
...
Gfx mat_jers_wario_wing_cap_Cap__CAP_[] = {
	gsSPCopyLightsPlayerPart(CAP),
	gsDPPipeSync(),
...
Gfx mat_jers_wario_wing_cap_Emblem__EMBLEM__layer2[] = {
	gsSPLight(&jers_wario_wing_cap_Emblem__EMBLEM__layer2_lights.l, 1),
    gsSPLight(&jers_wario_wing_cap_Emblem__EMBLEM__layer2_lights.a, 2),
	...
	gsSPTexture(65535, 65535, 0, 0, 1),
	gsDPSetTextureImage(G_IM_FMT_I, G_IM_SIZ_8b_LOAD_BLOCK, 1, jers_wario_wing_cap_wario_cutout_i8),
	...
	gsDPSetTextureImage(G_IM_FMT_I, G_IM_SIZ_8b_LOAD_BLOCK, 1, jers_wario_wing_cap_logo_W_i8),
...
Gfx mat_revert_jers_wario_wing_cap_Emblem__EMBLEM__layer2[] = {
	gsDPPipeSync(),
	gsDPSetRenderMode(G_RM_AA_ZB_OPA_DECAL, G_RM_AA_ZB_OPA_DECAL2),
	gsSPEndDisplayList(),
};

Gfx jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_4[] = {
	gsSPDisplayList(mat_jers_wario_wing_cap_Wing_New),
	gsSPDisplayList(jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_4_tri_0),
	gsSPDisplayList(mat_revert_jers_wario_wing_cap_Wing_New),
	gsSPEndDisplayList(),
};

Gfx jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_1[] = {
	gsSPDisplayList(mat_jers_wario_wing_cap_Cap_Dark__CAP_),
	gsSPDisplayList(jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_jers_wario_wing_cap_Cap__CAP_),
	gsSPDisplayList(jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_1_tri_1),
	gsSPEndDisplayList(),
};

Gfx jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_2[] = {
	gsSPDisplayList(mat_jers_wario_wing_cap_Emblem__EMBLEM__layer2),
	gsSPDisplayList(jers_wario_wing_cap_Wing_Cap_DL_mesh_layer_2_tri_0),
	gsSPDisplayList(mat_revert_jers_wario_wing_cap_Emblem__EMBLEM__layer2),
	gsSPEndDisplayList(),
};

Gfx jers_wario_wing_cap_material_revert_render_settings[] = {
	gsDPPipeSync(),
