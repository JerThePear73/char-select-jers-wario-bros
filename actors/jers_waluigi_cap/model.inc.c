Lights1 jers_waluigi_cap_Emblem__EMBLEM__layer2_lights = gdSPDefLights1(
	0xFF, 0xC3, 0x0,
	0x0, 0x0, 0x0, 0x28, 0x28, 0x28);

Lights1 jers_waluigi_cap_Cap__CAP__lights = gdSPDefLights1(
	0x34, 0xA, 0x4A,
	0x6F, 0x1F, 0x9A, 0x28, 0x28, 0x28);

Lights1 jers_waluigi_cap_Cap_Dark__CAP__lights = gdSPDefLights1(
	0x34, 0xA, 0x4A,
	0x6F, 0x1F, 0x9A, 0x28, 0x28, 0x28);

Gfx jers_waluigi_cap_logo_cutout_waluigi_i8_aligner[] = {gsSPEndDisplayList()};
u8 jers_waluigi_cap_logo_cutout_waluigi_i8[] = {
	#include "actors/jers_waluigi_cap/logo_cutout_waluigi.i8.inc.c"
};

Gfx jers_waluigi_cap_logo_L_i8_aligner[] = {gsSPEndDisplayList()};
u8 jers_waluigi_cap_logo_L_i8[] = {
	#include "actors/jers_waluigi_cap/logo_L.i8.inc.c"
};

Vtx jers_waluigi_cap_Cap_DL_mesh_layer_2_vtx_0[8] = {
...
Gfx jers_waluigi_cap_Cap_DL_mesh_layer_2_tri_0[] = {
	gsSPVertex(jers_waluigi_cap_Cap_DL_mesh_layer_2_vtx_0 + 0, 8, 0),
	gsSP2Triangles(0, 1, 2, 0, 3, 1, 0, 0),
	gsSP2Triangles(4, 5, 6, 0, 5, 7, 6, 0),
	gsSPEndDisplayList(),
};

Vtx jers_waluigi_cap_Cap_DL_mesh_layer_1_vtx_0[80] = {
...
Gfx jers_waluigi_cap_Cap_DL_mesh_layer_1_tri_0[] = {
	gsSPVertex(jers_waluigi_cap_Cap_DL_mesh_layer_1_vtx_0 + 0, 32, 0),
	...
	gsSPVertex(jers_waluigi_cap_Cap_DL_mesh_layer_1_vtx_0 + 32, 32, 0),
	...
	gsSPVertex(jers_waluigi_cap_Cap_DL_mesh_layer_1_vtx_0 + 64, 16, 0),
	gsSP2Triangles(0, 1, 2, 0, 0, 2, 3, 0),
...
Vtx jers_waluigi_cap_Cap_DL_mesh_layer_1_vtx_1[17] = {
...
Gfx jers_waluigi_cap_Cap_DL_mesh_layer_1_tri_1[] = {
	gsSPVertex(jers_waluigi_cap_Cap_DL_mesh_layer_1_vtx_1 + 0, 17, 0),
	gsSP2Triangles(0, 1, 2, 0, 3, 4, 5, 0),
...
Gfx mat_jers_waluigi_cap_Emblem__EMBLEM__layer2[] = {
	gsSPLight(&jers_waluigi_cap_Emblem__EMBLEM__layer2_lights.l, 1),
    gsSPLight(&jers_waluigi_cap_Emblem__EMBLEM__layer2_lights.a, 2),
	...
	gsDPSetTextureImage(G_IM_FMT_I, G_IM_SIZ_8b_LOAD_BLOCK, 1, jers_waluigi_cap_logo_cutout_waluigi_i8),
	...
	gsDPSetTextureImage(G_IM_FMT_I, G_IM_SIZ_8b_LOAD_BLOCK, 1, jers_waluigi_cap_logo_L_i8),
...
Gfx mat_revert_jers_waluigi_cap_Emblem__EMBLEM__layer2[] = {
	gsDPPipeSync(),
	gsSPEndDisplayList(),
};

Gfx mat_jers_waluigi_cap_Cap__CAP_[] = {
...
Gfx mat_jers_waluigi_cap_Cap_Dark__CAP_[] = {
	gsSPCopyLightsPlayerPart(CAP),
	gsDPPipeSync(),
...
Gfx jers_waluigi_cap_Cap_DL_mesh_layer_2[] = {
	gsSPDisplayList(mat_jers_waluigi_cap_Emblem__EMBLEM__layer2),
	gsSPDisplayList(jers_waluigi_cap_Cap_DL_mesh_layer_2_tri_0),
	gsSPDisplayList(mat_revert_jers_waluigi_cap_Emblem__EMBLEM__layer2),
	gsSPEndDisplayList(),
};

Gfx jers_waluigi_cap_Cap_DL_mesh_layer_1[] = {
	gsSPDisplayList(mat_jers_waluigi_cap_Cap__CAP_),
	gsSPDisplayList(jers_waluigi_cap_Cap_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_jers_waluigi_cap_Cap_Dark__CAP_),
	gsSPDisplayList(jers_waluigi_cap_Cap_DL_mesh_layer_1_tri_1),
	gsSPEndDisplayList(),
};

Gfx jers_waluigi_cap_material_revert_render_settings[] = {
	gsDPPipeSync(),
