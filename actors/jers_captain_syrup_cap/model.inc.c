Lights1 jers_captain_syrup_cap_Hat__CAP__lights = gdSPDefLights1(
	0x68, 0x0, 0x7F,
	0xD2, 0x0, 0xFF, 0x28, 0x28, 0x28);

Lights1 jers_captain_syrup_cap_Hat_No_Culling__CAP__lights = gdSPDefLights1(
	0x68, 0x0, 0x7F,
	0xD2, 0x0, 0xFF, 0x28, 0x28, 0x28);

Vtx jers_captain_syrup_cap_Cap_DL_mesh_layer_1_vtx_0[57] = {
...
Gfx jers_captain_syrup_cap_Cap_DL_mesh_layer_1_tri_0[] = {
	gsSPVertex(jers_captain_syrup_cap_Cap_DL_mesh_layer_1_vtx_0 + 0, 32, 0),
	...
	gsSPVertex(jers_captain_syrup_cap_Cap_DL_mesh_layer_1_vtx_0 + 32, 25, 0),
...
Vtx jers_captain_syrup_cap_Cap_DL_mesh_layer_1_vtx_1[8] = {
...
Gfx jers_captain_syrup_cap_Cap_DL_mesh_layer_1_tri_1[] = {
	gsSPVertex(jers_captain_syrup_cap_Cap_DL_mesh_layer_1_vtx_1 + 0, 8, 0),
...
Gfx mat_jers_captain_syrup_cap_Hat__CAP_[] = {
...
Gfx mat_jers_captain_syrup_cap_Hat_No_Culling__CAP_[] = {
...
Gfx mat_revert_jers_captain_syrup_cap_Hat_No_Culling__CAP_[] = {
	gsSPGeometryMode(0, G_CULL_BACK),
	gsDPPipeSync(),
	gsSPEndDisplayList(),
};

Gfx jers_captain_syrup_cap_Cap_DL_mesh_layer_1[] = {
	gsSPDisplayList(mat_jers_captain_syrup_cap_Hat__CAP_),
	gsSPDisplayList(jers_captain_syrup_cap_Cap_DL_mesh_layer_1_tri_0),
	gsSPDisplayList(mat_jers_captain_syrup_cap_Hat_No_Culling__CAP_),
	gsSPDisplayList(jers_captain_syrup_cap_Cap_DL_mesh_layer_1_tri_1),
	gsSPDisplayList(mat_revert_jers_captain_syrup_cap_Hat_No_Culling__CAP_),
	gsSPEndDisplayList(),
};

Gfx jers_captain_syrup_cap_material_revert_render_settings[] = {
	gsDPPipeSync(),
